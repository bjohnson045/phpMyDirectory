<input class="text <?php echo $class; ?>" type="<?php if($plaintext) { ?>text<?php } else { ?>password<?php } ?>" value="<?php echo $this->escape($value); ?>"<?php echo $attributes; ?>>
<?php if($generate) { ?>
    ...
    <a id="<?php echo $name; ?>_generate_password" target="_blank" class="btn btn-small">Generate</a>
<?php } ?>
<?php if($strength) { ?>
