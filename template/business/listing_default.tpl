    ...
    <div class="col-sm-12">
        ...
        <div class="btn-row">
            ...
            <?php if($classifieds_count) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $classifieds_url; ?>"><i class="fa fa-dropbox"></i> <?php echo $lang['public_listing_classifieds']; ?><span class="badge"><?php echo $classifieds_count; ?></span></a>
            <?php } ?>
            <?php if($images_count) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $images_url; ?>"><span class="glyphicon glyphicon-picture"></span> <?php echo $lang['public_listing_images']; ?><span class="badge"><?php echo $images_count; ?></span></a>
            <?php } ?>
            <?php if($events_count) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $events_url; ?>"><i class="fa fa-calendar"></i> <?php echo $lang['public_listing_events']; ?><span class="badge"><?php echo $events_count; ?></span></a>
            <?php } ?>
            <?php if($jobs_count) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $jobs_url; ?>"><i class="fa fa-building-o"></i> <?php echo $lang['public_listing_jobs']; ?><span class="badge"><?php echo $jobs_count; ?></span></a>
            <?php } ?>
            <?php if($documents_count) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $documents_url; ?>"><span class="glyphicon glyphicon-file"></span> <?php echo $lang['public_listing_documents']; ?><span class="badge"><?php echo $documents_count; ?></span></a>
            <?php } ?>
            <?php if($reviews_add_url) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $reviews_add_url; ?>"><span class="glyphicon glyphicon-comment"></span> <?php echo $lang['public_listing_reviews_add']; ?></a>
            <?php } ?>
            <?php if($reviews_count) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $reviews_url; ?>"><span class="glyphicon glyphicon-comment"></span> <?php echo $lang['public_listing_reviews']; ?><span class="badge"><?php echo $reviews_count; ?></span></a>
            <?php } ?>
            <?php if($print) { ?>
                <a class="btn btn-sm btn-muted" rel="nofollow" href="<?php echo $print; ?>"><span class="glyphicon glyphicon-print"></span> <?php echo $lang['public_listing_print']; ?></a>
            <?php } ?>
            <?php if($email_friend) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $email_friend; ?>"><span class="glyphicon glyphicon-user"></span> <?php echo $lang['public_listing_email_friend']; ?></a>
            <?php } ?>
            <?php if($send_to_phone) { ?>
                <a class="btn btn-sm btn-muted" id="send_to_phone" href=""><span class="glyphicon glyphicon-phone"></span> <?php echo $lang['public_listing_send_to_phone']; ?></a>
            <?php } ?>
            <?php if($pdf_url) { ?>
                <a class="btn btn-sm btn-muted" rel="nofollow" href="<?php echo $pdf_url; ?>" target="_blank"><span class="glyphicon glyphicon-file"></span> <?php echo $lang['public_listing_pdf_download']; ?></a>
            <?php } ?>
            <?php if($favorites_url) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $favorites_url; ?>"><span class="glyphicon glyphicon-heart<?php if($favorites) { ?> text-danger<?php } ?>"></span> <?php echo $favorites_text; ?></a>
            <?php } ?>
            <?php if($suggestion_url) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $suggestion_url; ?>"><span class="glyphicon glyphicon-question-sign"></span> <?php echo $lang['public_listing_suggestion']; ?></a>
            <?php } ?>
            <?php if($claim_url) { ?>
                <a class="btn btn-sm btn-muted" href="<?php echo $claim_url; ?>"><span class="glyphicon glyphicon-check"></span> <?php echo $lang['public_listing_claim']; ?></a>
            <?php } ?>
            <?php if($report_url) { ?>
                <a class="btn btn-sm btn-muted" rel="nofollow" href="<?php echo $report_url; ?>"><span class="glyphicon glyphicon-exclamation-sign"></span> <?php echo $lang['public_listing_report']; ?></a>
            <?php } ?>
        </div>
    </div>
    </div>
