...
<title><?php echo $lang['user_invoices_id']; ?>: <?php echo $id; ?></title>
<style>
<!--
...
<table align="center" border="0" width="600" cellspacing="0" cellpadding="0" class="wrapper-table">
    <tr>
        ...
        <td align="right">
            <table border="0" align="right" cellspacing="0" cellpadding="0" style="padding-right: 10px;">
                <tr>
                    <td align="right" class="header_label"><?php echo $lang['user_invoices_id']; ?>:</td>
                    <td><?php echo $id; ?></td>
                </tr>
                <tr>
                    <td align="right" class="header_label"><?php echo $lang['user_invoices_date']; ?>:</td>
                    <td><?php echo $date; ?></td>
                </tr>
                <tr>
                    <td align="right" class="header_label"><?php echo $lang['user_invoices_date_due']; ?>:</td>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0" style="padding-top: 20px;">
                <tr>
                    <td width="50%" valign="top">
                        <b><?php echo $lang['user_invoices_invoiced_to']; ?>:</b><br />
                    ...
                    <td valign="top">
                        <b><?php echo $lang['user_invoices_pay_to']; ?>:</b><br />
    ...
    <tr>
        <td colspan="2">
            <table border="0" width="100%" cellspacing="0" cellpadding="0" class="table_border" style="border: 1px solid #C0C0C0; margin: 40px 0px 10px 0px;">
                <tr>
                    <td width="70%" class="invoice_amount_header" valign="top"><?php echo $lang['user_invoices_description']; ?></td>
                    <td class="invoice_amount_header"><?php echo $lang['user_invoices_total']; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="invoice_amount_header" width="70%" align="right"><b><?php echo $lang['user_invoices_subtotal']; ?>:</b></td>
                    <td class="invoice_amount_header"><?php echo format_number_currency($subtotal); ?></td>
                </tr>
                <?php if($discount_code) { ?>
                    <tr>
                        <td class="invoice_amount_header" width="70%" align="right"><b><?php echo $lang['user_invoices_discount_code']; ?> (<?php echo $discount_code; ?>):</b></td>
                        <td class="invoice_amount_header">(<?php echo format_number_currency($discount_code_value); ?>)</td>
                    </tr>
                <?php } ?>
                <?php if($tax_rate != 0.00) { ?>
                <tr>
                    <td class="invoice_amount_header" width="70%" align="right"><b><?php echo $lang['user_invoices_tax']; ?> (<?php echo $tax_rate; ?>%):</b></td>
                    <td class="invoice_amount_header"><?php echo format_number_currency($tax); ?></td>
                </tr>
                <?php } ?>
                <?php if($tax_rate2 != 0.00) { ?>
                <tr>
                    <td class="invoice_amount_header" width="70%" align="right"><b><?php echo $lang['user_invoices_tax2']; ?> (<?php echo $tax_rate2; ?>%):</b></td>
                    <td class="invoice_amount_header"><?php echo format_number_currency($tax2); ?></td>
                </tr>
                <?php } ?>
                <tr>
                    <td class="invoice_amount_header" width="70%" align="right"><b><?php echo $lang['user_invoices_total']; ?>:</b></td>
    ...
    <tr>
        <td><b><?php echo $lang['user_transactions']; ?></b></td>
    </tr>
    <tr>
        <td colspan="2">
            <table border="0" width="100%" cellspacing="0" cellpadding="0" class="table_border" style="border: 1px solid #C0C0C0; margin-top: 10px;">
                <tr>
                    <td width="20%" class="invoice_amount_header" valign="top"><?php echo $lang['user_transactions_date']; ?></td>
                    <td width="20%" class="invoice_amount_header"><?php echo $lang['user_transactions_gateway']; ?></td>
                    <td width="20%" class="invoice_amount_header"><?php echo $lang['user_transactions_id']; ?></td>
                    <td width="20%" class="invoice_amount_header"><?php echo $lang['user_transactions_amount']; ?></td>
                </tr>
                <?php if(!$transactions) { ?>
                    <tr><td class="invoice_amount_rows" colspan="4" align="center"><?php echo $lang['user_invoices_no_transactions']; ?></td></tr>
                <?php } else { ?>
                    <?php foreach($transactions as $transaction) { ?>
                        <tr>
                            ...
                            <td class="invoice_amount_rows"><?php echo $transaction['amount']; ?></td>
                        </tr>
                    <?php } ?>
                <?php } ?>
                <tr>
                    <td colspan="3" class="invoice_amount_header" width="80%" align="right"><b><?php echo $lang['user_invoices_balance']; ?>:</b></td>
...
<center><a href="javascript: self.close();"><?php echo $lang['user_invoices_close_window']; ?></a></center>
</body>
</html>