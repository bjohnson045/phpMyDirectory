<textarea class="form-control <?php echo $class; ?>" cols="10" rows="10"<?php echo $attributes; ?>>
<?php echo $value; ?>
</textarea>
<?php if($fullscreen) { ?>
    <p class="help-block">
        <a class="btn btn-small" id="<?php echo $id; ?>_fullscreen_link" href="#"><i class="icon-fullscreen"></i> <?php echo $lang['fullscreen']; ?></a>
    </p>
