...
<a class="btn btn-default" href="admin_classifieds_categories_statistics.php?action=download"><?php echo $lang['admin_classifieds_categories_download_impressions']; ?></a>
<h2><?php echo $lang['admin_classifieds_categories_statistics_graphs']; ?></h2>
<?php if(!count($impressions) AND !count($impressions_search) AND !count($counts)) { ?>
    <?php echo $lang['admin_classifieds_categories_statistics_no_data']; ?>
<?php } ?>
