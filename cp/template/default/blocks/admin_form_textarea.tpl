<textarea class="<?php echo $class; ?> form-control" cols="10" rows="10"<?php echo $attributes; ?>>
<?php echo $value; ?>
</textarea>
<?php if($fullscreen) { ?>
    <p class="help-block">
        <a class="btn btn-default btn-sm" id="<?php echo $id; ?>_fullscreen_link" href="#"><i class="glyphicon glyphicon-fullscreen"></i> Fullscreen</a>
    </p>
    <div id="<?php echo $id; ?>_fullscreen">
        <textarea style="width: 100%; height: 95%;<?php if($spellcheck) { ?> spellcheck="false"<?php } ?>"><?php echo $value; ?></textarea>
    </div>
